...
const Word: React.FC<WordProps> = ({children, progress, range}) => {
  ...
  return (
    <span className="relative mt-[12px] mr-1 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold">
...
export const MagicText: React.FC<MagicTextProps> = ({text}) => {
  ...
  return (
    <p
      ref={container}
      className="flex flex-wrap text-justify leading-[0.8] w-full"
    >
      {words.map((word, i) => {
